 ...
 *   VOID_NORMAL : Frammenti del Vuoto (Maskfly) — unico nodo BATTLE del ramo
...
public class EnemyFactory {
    ...
    /**
     * Nemico del nodo nHK1 "Frammenti del Vuoto".
     * Maskfly: agile, basso HP, attacchi multipli.
     */
    public GameCharacter createVoidEnemy(int playerLevel) {
        return new GameCharacter("Maskfly", 40 + playerLevel * 5, 3);
    }
