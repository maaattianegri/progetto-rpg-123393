 ...
 *   #3498db  🔵 Blu       → Paladino  (scudo/cura/smite)
 *   #e67e22  🟠 Arancione → Mago / Dracomante (fuoco/magia)
 *   #27ae60  🟢 Verde     → Assassino (veleno)
 *   #c77dff  🟣 Viola     → Neutrale  (utilità, disponibile a tutti)
 *   #9aaaba  ⚪ Argento   → Starter   (multiclasse: Colpo di Spada, Scudo di Legno)
 */
public class CardStyleHelper {
    ...
    public static String symbol(String name) {
        return switch (borderColor(name)) {
            case "#9aaaba" -> "★";   // stella argento = starter
            case "#e74c3c" -> "⚔";
            case "#3498db" -> "🛡";
            case "#e67e22" -> "🔥";
            case "#27ae60" -> "☠";
